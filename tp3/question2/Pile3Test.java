...
public class Pile3Test extends junit.framework.TestCase {
    ...
    private question2.Pile3 pile31;
    private question2.Pile3 pile32;
    private question2.Pile3 pile33;
    ...
    {
        pile31 = new question2.Pile3();
        pile32 = new question2.Pile3();
        pile33 = new question2.Pile3(24);
    }

    public void test_Pile_capacite() {
        assertEquals(PileI.CAPACITE_PAR_DEFAUT, pile31.capacite());
    }
    ...
    public void test_Pile_equals() throws Exception {
        ...
        assertTrue("égalité de deux piles (1)? ", pile31.equals(pile32));
        assertTrue("égalité de deux piles (2)? ", pile32.equals(pile31));
        assertTrue("égalité de deux piles (3)? ", pile31.equals(pile31));

        pile32.empiler(1);
        assertFalse("égalité de deux piles (4)? ", pile31.equals(pile32));
    }
}